package com.mobile.qg.qgnetdisk.view;
...
public class VerificationCodeView extends LinearLayout implements TextWatcher, View.OnKeyListener, View.OnFocusChangeListener {
    ...
    public VerificationCodeView(Context context, AttributeSet attrs) {
        ...
        mEtNumber = typedArray.getInteger(R.styleable.vericationCodeView_et_number, 4);
        int inputType = typedArray.getInt(R.styleable.vericationCodeView_et_inputType, VCInputType.NUMBER.ordinal());
        mEtInputType = VCInputType.values()[inputType];
        mEtWidth = typedArray.getDimensionPixelSize(R.styleable.vericationCodeView_et_width, 180);
        mEtTextColor = typedArray.getColor(R.styleable.vericationCodeView_et_text_color, Color.BLACK);
        mEtTextSize = typedArray.getDimensionPixelSize(R.styleable.vericationCodeView_et_text_size, 16);
        mEtTextBg = typedArray.getResourceId(R.styleable.vericationCodeView_et_bg, R.drawable.et_login_code);
        mCursorDrawable = typedArray.getResourceId(R.styleable.vericationCodeView_et_cursor, R.drawable.et_cursor);
